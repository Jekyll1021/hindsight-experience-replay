...
def get_args():
    ...
    parser.add_argument('--random-eps', type=float, default=0.6, help='random eps')
    ...
    parser.add_argument('--lr-critic', type=float, default=1e-6, help='the learning rate of the critic')
